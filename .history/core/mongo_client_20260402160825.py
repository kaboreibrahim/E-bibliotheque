            ...
            if _client is None:   # double-check inside lock
                try:
                    ...
                    if "mongodb+srv://" in uri:
                        try:
                        ...
                        except (ConnectionFailure, ServerSelectionTimeoutError) as atlas_error:
                            logger.warning(f"⚠️ MongoDB Atlas indisponible, tentative de connexion locale : {atlas_error}")
                            ...
                            _client.admin.command('ping')
                            logger.info("✅ Connexion MongoDB locale établie (fallback).")
                    else:
                        ...
                        # Ping pour valider la connexion
                        _client.admin.command('ping')
                        logger.info("✅ Connexion MongoDB locale établie.")
