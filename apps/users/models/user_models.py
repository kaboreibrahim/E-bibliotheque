...
class User(AbstractUser, SafeDeleteModel):
    ...
    class UserType(models.TextChoices):
        ...
        ENSEIGNANT_CHERCHEUR = 'ENSEIGNANT_CHERCHEUR', 'Enseignant-Chercheur'
    ...
    @property
    def is_enseignant_chercheur(self):
        return self.user_type == self.UserType.ENSEIGNANT_CHERCHEUR

    @property
    def is_chercheur(self):
        return self.user_type == self.UserType.CHERCHEUR
    ...
    def requires_2fa(self):
        ...
        return self.user_type in (
            ...
            self.UserType.ENSEIGNANT_CHERCHEUR,
            self.UserType.CHERCHEUR,
        )
