...
# =============================================================================
# 👨‍🏫  ENSEIGNANT-CHERCHEUR — email + password
# =============================================================================

class EnseignantChercheurLoginSerializer(serializers.Serializer):
    email = serializers.EmailField(
        help_text="Adresse email de l'enseignant-chercheur."
    )
    password = serializers.CharField(
        write_only=True,
        style={'input_type': 'password'},
...
class EnseignantChercheurTOTPVerifySerializer(serializers.Serializer):
    user_id = serializers.UUIDField(
        help_text="UUID retourné à l'étape 1."
    )
    totp_code = serializers.CharField(
...
# =============================================================================
# 🔬  CHERCHEUR — email + password
# =============================================================================

class ChercheurLoginSerializer(serializers.Serializer):
    email = serializers.EmailField(
        help_text="Adresse email du chercheur."
    )
    password = serializers.CharField(
        write_only=True,
        style={'input_type': 'password'},
...
class ChercheurTOTPVerifySerializer(serializers.Serializer):
    user_id = serializers.UUIDField(
        help_text="UUID retourné à l'étape 1."
    )
    totp_code = serializers.CharField(
