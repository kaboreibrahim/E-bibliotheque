...
class EtudiantDetailSerializer(serializers.Serializer):
    ...
    date_of_birth = serializers.DateField(source='user.date_of_birth', allow_null=True)
...
# =============================================================================
# CREATION ENSEIGNANT-CHERCHEUR (par Admin uniquement)
# =============================================================================

class EnseignantChercheurCreateSerializer(serializers.Serializer):
    first_name = serializers.CharField(max_length=100, help_text="Prenom.")
    last_name = serializers.CharField(max_length=100, help_text="Nom de famille.")
    email = serializers.EmailField(help_text="Email de connexion.")
    phone = serializers.CharField(max_length=17, help_text="Telephone avec indicatif.")
    date_of_birth = serializers.DateField(required=False, allow_null=True)
    password = serializers.CharField(
    ...
    numero_piece = serializers.CharField(
        ...
        help_text="Numero de piece d'identite."
    )
    lieu_habitation = serializers.CharField(
        required=False, allow_blank=True, max_length=255
    )
    annee_service = serializers.IntegerField(
        required=False, allow_null=True,
        help_text="Annee d'entree en service."
    )
    specialite_enseignee = serializers.CharField(
        required=False, allow_blank=True, max_length=255,
        help_text="Specialite enseignee ou domaine de recherche."
    )
    ...
    def validate_phone(self, value):
        phone = re.sub(r'\s+', '', value)
        if not re.match(r'^\+?[\d]{8,15}$', phone):
            raise serializers.ValidationError("Numero invalide. Format attendu: +2250701002003")
        return phone
...
class EnseignantChercheurUpdateSerializer(serializers.Serializer):
    first_name = serializers.CharField(max_length=100, required=False)
    last_name = serializers.CharField(max_length=100, required=False)
    phone = serializers.CharField(max_length=17, required=False)
    date_of_birth = serializers.DateField(required=False, allow_null=True)
    numero_piece = serializers.CharField(max_length=100, required=False, allow_blank=True)
    lieu_habitation = serializers.CharField(max_length=255, required=False, allow_blank=True)
    annee_service = serializers.IntegerField(required=False, allow_null=True)
    specialite_enseignee = serializers.CharField(max_length=255, required=False, allow_blank=True)
...
class EnseignantChercheurDetailSerializer(serializers.Serializer):
    id = serializers.UUIDField()
    ...
    numero_piece = serializers.CharField()
    lieu_habitation = serializers.CharField()
    annee_service = serializers.IntegerField(allow_null=True)
    specialite_enseignee = serializers.CharField()
    statut_compte = serializers.CharField()
    activation_suspendue = serializers.BooleanField()
    created_at = serializers.DateTimeField()


# =============================================================================
# CREATION CHERCHEUR (par Admin uniquement)
# =============================================================================

class ChercheurCreateSerializer(serializers.Serializer):
    first_name = serializers.CharField(max_length=100, help_text="Prenom.")
    last_name = serializers.CharField(max_length=100, help_text="Nom de famille.")
    email = serializers.EmailField(help_text="Email de connexion.")
    phone = serializers.CharField(max_length=17, help_text="Telephone avec indicatif.")
    ...
    specialite_enseignee = serializers.CharField(
        required=False, allow_blank=True, max_length=255,
        help_text="Domaine de recherche."
    )
...
class ChercheurUpdateSerializer(serializers.Serializer):
    first_name = serializers.CharField(max_length=100, required=False)
    last_name = serializers.CharField(max_length=100, required=False)
    phone = serializers.CharField(max_length=17, required=False)
    date_of_birth = serializers.DateField(required=False, allow_null=True)
...
class ChercheurDetailSerializer(serializers.Serializer):
    id = serializers.UUIDField()
    user_id = serializers.UUIDField(source='user.id')
    user_type = serializers.CharField(source='user.user_type')
    email = serializers.EmailField(source='user.email')
