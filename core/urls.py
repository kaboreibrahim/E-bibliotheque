...
urlpatterns = [
    ...
    path('api/enseignants-chercheurs/', include((enseignant_chercheur_urlpatterns, 'users'), namespace='enseignants-chercheurs')),
    path('api/chercheurs/', include((chercheur_urlpatterns, 'users'), namespace='chercheurs')),
]
